    ...
    return (
        <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3 gap-4 px-4 py-16">
            <div className="lg:col-span-2 flex flex-col justify-evenly">
                ...
                <div className="grid sm:grid-cols-2 gap-8 py-4">
                    <div className="flex flex-col lg:flex-row items-center text-center">
                        ...
                        <h3 className="py-3">LEADING SERVICES</h3>
                        <p className="py-1">ALL-INCLUSIVE COMAPANY FOR 20 YEARS IN-A-ROW</p>
                    </div>
            ...
            <div>
                ...
                <form className="w-full border text-left">
                    ...
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 w-full my-4">Rates & Availability</button>
                </form>
            </div>
